export const HomePage = () => {
    return (
        <p>
            ...
            <br/>
            <br/>
            As a backend engineer, I test my own code.
            I don't wait for the Quality Engineers to test my code for me.
            <br/>
            Although doing it together is also good.

            <br/>
            <br/>
            As a backend engineer, I deploy my own code.
            Or rather, I let the CI/CD do it for me.
            <br/>
            Tinkering with the CI/CD is something I only want to do once.
            ...
            <p className="font-mono">arel(dot)latoga(at)hotmail(full-stop)com</p>
            <br/>
        </p>
    );
};